...
namespace GrammerTest.Grammer
{
    public  class OperatorNodeFactory
    {
        ...
        public static OperatorNode CreateOperatorNode(OperatorType type)
        {
            return null;
        }
        ...
        public static OperatorNode CreateStringNode(OperatorNode type)
        {
            return null;
        }
        ...
        public static OperatorNode CreateNumberNode(string value)
        {
            return null;
        }
