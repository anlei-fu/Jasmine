...
{
    public class DefaultReflectionCache : AbstractReflectionCache<TypeMetaData, Type>, ITypeCache
    {
        private DefaultReflectionCache():base()
        {

        }
        public static readonly ITypeCache Instance = new DefaultReflectionCache();
