...
namespace Jasmine.Ioc
{
    public class JasmineServiceProvider : IServiceProvider
    {
        ...
        private readonly IServiceMetaDataManager _metaDataManager = DefaultServiceMetaDataManager.Instance;
        private readonly IServiceMetaDataReflectResolver _reflectResolver = JasmineServiceMetaDataReflectResolver.Instance;
        ...
        public object GetService(Type serviceType,DependencyCheckNode node)
        {
            ...
            {
                var impl = _metaDataManager.GetImplement(serviceType);
